...
public class DollarFishingPoleItem extends Item implements Vanishable {

    public DollarFishingPoleItem(Properties pProperties) {
        super(pProperties);
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level pLevel, Player pPlayer, InteractionHand pHand) {
        ...
        if (pPlayer.fishing != null) {
            ...
            if (!pLevel.isClientSide) {
                ...
                pLevel.addFreshEntity(new DollarFishingHookEntity(pPlayer, pLevel, j, k));
            }
