...
public class DollarFishingHookRenderer extends GeoEntityRenderer<DollarFishingHookEntity> {

    public DollarFishingHookRenderer(EntityRendererProvider.Context renderManager) {
        super(renderManager, new SimpleGeoEntityModel<>(RGRBillionaire.MODID, "dollar_bobber_entity"));
    }

    @Override
    public void render(DollarFishingHookEntity pEntity, float pEntityYaw, float pPartialTicks, PoseStack pMatrixStack, MultiBufferSource pBuffer, int pPackedLight) {
